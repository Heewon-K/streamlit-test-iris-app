...
colours = {'setosa':'red', 'virginica':'green', 'versicolor':'blue'}
...
if selectSpecies:
    ...
    for aSpecies in selectSpecies:
        ...
        plt.scatter(df[selectX], df[selectY], color = colours[aSpecies], alpha = selectAlpha, label = aSpecies)
